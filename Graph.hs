{-
  ...
  A "Hilbert space graph" is a graph whose vertices represent vectors constructed
  from nth roots of unity in a dimension d Hilbert space.  Vertices are numbered with
  non-negative integers called "magic numbers".  Each vertex is associated with a unique
  vector; given n and d, vertices can be converted to vectors and vice versa.
